...
def _run_profile(device: torch.device, status_callback: Callable[[str], None] | None = None) -> AdaptiveSettings:
    """Run a two-phase sweep to determine good safety/prefetch values."""
    ...
    # Phase 1: fix safety and find best prefetch depth.
    ...
    # Phase 2: lock prefetch and try different safety factors.
...
def _benchmark_settings(
    ...
    try:
        ...
        if status_callback:
            ...
            prefix = f"[Phase {phase}] " if phase is not None else ""
