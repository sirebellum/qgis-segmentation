...
SOURCES = \
	__init__.py \
	segmenter.py segmenter_dialog.py

PLUGINNAME = segmenter

PY_FILES = \
	__init__.py \
	segmenter.py segmenter_dialog.py

UI_FILES = segmenter_dialog_base.ui
...
QGISDIR=/home/gislord/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
